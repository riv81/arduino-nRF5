...
#ifndef _VARIANT_SKYLAB_SKB369_NANO2_REPLACEMENT_
#define _VARIANT_SKYLAB_SKB369_NANO2_REPLACEMENT_
...
// LEDs  NOTE no built in led D13 maps to max unsigned 32bit int i.e. (uint32_t)-1
